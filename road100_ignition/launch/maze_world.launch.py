...
def generate_launch_description():
    ...
    turtlebot4_ignition_pkg_path = get_package_share_directory('turtlebot4_ignition_bringup')
    ...
    ign_resource_path = SetEnvironmentVariable(
        ...
        value=[
            os.path.join(turtlebot4_ignition_pkg_path, 'worlds'), ':' +
    ...
    gazebo = IncludeLaunchDescription(
        ...
        launch_arguments={'gz_args': f'-r maze.sdf'}.items(),
    )
